...
public:
    ...
    virtual ~EcranPrincipal() override;
...
protected slots:
    ...
    void on_lineEditPointX0XPixel_textChanged(const QString& text);
    void on_lineEditPointX0YPixel_textChanged(const QString& text);
    void on_lineEditPointX0Valeur_textChanged(const QString& text);
    void on_lineEditPointX1XPixel_textChanged(const QString& text);
    void on_lineEditPointX1YPixel_textChanged(const QString& text);
    void on_lineEditPointX1Valeur_textChanged(const QString& text);
    void on_lineEditPointY0XPixel_textChanged(const QString& text);
    void on_lineEditPointY0YPixel_textChanged(const QString& text);
    void on_lineEditPointY0Valeur_textChanged(const QString& text);
    void on_lineEditPointY1XPixel_textChanged(const QString& text);
    void on_lineEditPointY1YPixel_textChanged(const QString& text);
    void on_lineEditPointY1Valeur_textChanged(const QString& text);
    ...
    void on_lineEditPointDepartXPixel_textChanged(const QString& text);
    void on_lineEditPointDepartYPixel_textChanged(const QString& text);
    void on_lineEditPointArriveeXPixel_textChanged(const QString& text);
    void on_lineEditPointArriveeYPixel_textChanged(const QString& text);
    void on_lineEditPointManuelXPixel_textChanged(const QString& text);
    void on_lineEditPointManuelYPixel_textChanged(const QString& text);
...
private:
    // Attributs de classe
    Ui::EcranPrincipal* _ui { nullptr };
    Etude _etude;
    Etude _etudeReference;
    QPushButton* _pushButtonActif { nullptr };
};
